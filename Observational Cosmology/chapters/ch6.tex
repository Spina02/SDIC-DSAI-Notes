\chapter{Galaxy SED and Evolution} \label{ch:galaxy_seds}

\begin{warningblock}[Chapter not finished!]
This chapter is not finished yet: still need to check for correctness and add images
\end{warningblock}
