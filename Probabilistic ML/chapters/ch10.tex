...
$$
\nabla_\lambda \mathcal{L}(\lambda) = \int \left\{\nabla_\lambda [\log p(x,z) - \log q(z|\lambda)]\right\}q(z|\lambda)\,dz + \int \left\{\nabla_\lambda q(z|\lambda)\right\}[\log p(x,z) - \log q(z|\lambda)]\,dz 
$$
