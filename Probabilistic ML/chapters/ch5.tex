...
\begin{itemize}[label=$\blacktriangleright$, left=0.5pt]
    \item \textbf{Filtering}: given the observations $\underbar{x}$, we want to compute tue distribution over hidden states of the last latent variable at the end of the sequence, i.e. compute the probability $p(z_n|\underbar{x})$.
