...
$$
Solving for the observed mean absolute magnitude $\langle M \rangle_m$:
$$
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{assets/mw-kinematics.png}
...
\begin{minipage}{0.4\textwidth}
    \centering
    \includegraphics[width=\textwidth]{assets/oort.png}
\end{minipage}%
\hfill
\begin{minipage}{0.55\textwidth}
...
$$
The triangle $\odot C P$ gives us the relation $R \sin \alpha = R_0 \cos l - r$. Substituting this into the expression for $v_r$:
$$
...
This velocity-distance relation is the key: by measuring the radial velocity of a cloud via the Doppler shift of the 21\,cm line and assuming a known rotation curve $V(R)$, one can solve for the cloud's Galactocentric distance $R$, and hence its position in the Galaxy. 
