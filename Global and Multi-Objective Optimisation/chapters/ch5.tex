...
\begin{itemize}
    \item \textbf{New Mutation Strategy:} JADE introduces the \texttt{DE/current-to-best} mutation scheme, which improves the balance between exploration and exploitation by guiding individuals toward the best solutions found so far.
