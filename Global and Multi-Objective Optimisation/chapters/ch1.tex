...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.5\textwidth]{assets/hill-climbing-1.png}
  \hspace{2em}
  \includegraphics[width=0.38\textwidth]{assets/hill-climbing-2.png}
  \caption{With a poor neighbourhood (left), hill climbing can get trapped in a local optimum.  A richer neighbourhood (right) may eliminate local traps.}
