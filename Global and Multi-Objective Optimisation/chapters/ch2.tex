...
\begin{figure}[H]
    ...
    \caption{\centering \small Left: Diagram showing the main components and their interactions in the evolutionary process. Right: Example of genetic operators (selection, crossover, mutation) acting on binary strings.}
    \label{fig:ga_cycle}
\end{figure}
...
\begin{figure}[H]
    ...
    \vspace{-0.5em}
    \caption{\centering Partially Mapped Crossover \cite{Tenemaza2020}.}
    \label{fig:pmx}
\end{figure}
\end{minipage}
...
\begin{figure}[H]
    ...
    \caption{\centering Cycle Crossover. \cite{Tenemaza2020}}
    \label{fig:cx}
\end{figure}
...
A \to \begin{bmatrix} c & d \\ a & c \end{bmatrix}, & 
...
d \to \begin{bmatrix} 0 & 1 \\ 0 & 1 \end{bmatrix}, &
...
\left[\begin{matrix}\\[-0.9em]
    \color{red!70!black}\begin{bmatrix} c & d \\ a & c \end{bmatrix} & 
...
\begin{bmatrix}\\[-0.9em]
    ...
    \color{red!70!black}\begin{bmatrix} 0 & 1 \\ 0 & 1 \end{bmatrix} & \hspace{-0.5em}
    ...
    \color{red!70!black}\begin{bmatrix} 1 & 0 \\ 0 & 0 \end{bmatrix} & \hspace{-0.5em}
    \color{green!60!black}\begin{bmatrix} 0 & 0 \\ 0 & 0 \end{bmatrix} & \hspace{-0.5em}
    \color{green!60!black}\begin{bmatrix} 1 & 1 \\ 1 & 1 \end{bmatrix} \\[0.9em]
